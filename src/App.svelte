            ...
            <MDBRow class="align-items-center">
                <MDBCol lg="6" md="12" sm="12">
                    <img
                        ...
                        src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/circle-cropped-pp.png"
                        alt="Profile"
                    />
                </MDBCol>
...
<MDBContainer class="mt-5 mb-5 banner">
    <MDBRow class="d-flex align-items-center">
        <MDBCol lg="6" md="12" sm="12">
            <img
                class="img-fluid"
                src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/analysis-self.webp"
                alt="analysis"
            />
        </MDBCol>
        <MDBCol lg="6" md="12" sm="12">
            <a href="/Documents/Simphiwe-Resume.pdf" target="_blank"
                ><MDBBtn size="lg" class="d-block mx-auto" gradient="aqua">Resume</MDBBtn></a
            >
        </MDBCol>
    </MDBRow>
</MDBContainer>
...
<MDBContainer class="mt-5 mb-5 banner">
    <MDBRow class="d-flex align-items-center">
        <MDBCol lg="6" md="12" sm="12">
            <a href="/Documents/Simphiwe-Reference-Letter.pdf" target="_blank"
                ><MDBBtn size="lg" class="d-block mx-auto" gradient="aqua">Reference Letter</MDBBtn
                ></a
            >
        </MDBCol>
        <MDBCol lg="6" md="12" sm="12">
            <img
                class="img-fluid"
                src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/group-coach.webp"
                alt="coaches"
            />
        </MDBCol>
    </MDBRow>
...
<MDBContainer fluid class="mt-5 mb-5">
    <MDBRow class="d-flex align-items-center">
        <MDBCol lg="4" md="12" sm="12">
            <img
                class="img-fluid d-block mx-auto"
                src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/portrait.webp"
                alt="coaches"
            />
        </MDBCol>
        <MDBCol lg="4" md="12" sm="12">
            <h2 class="text-center">
                I am a leader of good sense and sound values with a huge passion for developing
                people. I seek to contribute immensely to the quality of life of those I coach
                through sport and education. I have a driving passion for youth development and
                value hard work and humanity. I seek to continuously up-skill myself, striving to
                get better.
            </h2>
        </MDBCol>
        <MDBCol lg="4" md="12" sm="12">
            <img
                class="img-fluid d-block mx-auto"
                src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/self-mic.webp"
                alt="coaches"
            />
        </MDBCol>
    </MDBRow>
            ...
            <MDBCard>
                <MDBCardBody>
                    <form name="contact-me" method="POST">
                        ...
                        />
                        <br />
                        <label for="Textarea" class="grey-text font-weight-light"
                            >Your message...</label
                        >
                        <textarea name="message" class="form-control" id="Textarea" rows="8" />
                        <br />
        ...
        <MDBCol lg="6" md="12" sm="12">
            ...
            >
                ...
                <g id="undraw_junior_soccer_6sop 1" clip-path="url(#clip0)">
                    <path
                        id="Vector"
                        d="M384.301 501.338C377.901 501.332 371.604 502.959 366.008 506.065H402.548C396.968 502.96 390.687 501.333 384.301 501.338V501.338Z"
                        fill="#E6E6E6"
                    />
                    <path
                        id="Vector_2"
                        d="M455.206 496.611C444.515 496.599 434.082 499.902 425.346 506.065H485.026C476.302 499.909 465.884 496.606 455.206 496.611V496.611Z"
                        fill="#E6E6E6"
                    />
                    <path
                        id="Vector_3"
                    ...
                    <path
                        id="Vector_10"
                        d="M356.5 357.565L327.5 363.565L332.652 384.748C335.188 395.173 335.477 406.019 333.5 416.565V416.565C333.5 416.565 363.5 424.565 363.5 420.565C363.5 416.565 356.5 400.565 358.5 389.565C360.5 378.565 356.5 357.565 356.5 357.565Z"
                        fill="#63CFFF"
                    />
                    <path
                        id="Vector_11"
                    ...
                    <path
                        id="Vector_21"
                        d="M483.444 82.9341C473.531 63.0082 443.369 73.8757 448.27 95.5848C448.344 95.9085 448.42 96.2353 448.5 96.5653C453.666 117.115 462.107 136.699 473.5 154.565L462.5 203.565L450.5 228.565L475.5 234.565L506.5 159.565C506.5 159.565 497.949 112.092 483.444 82.9341Z"
                        fill="#2F2E41"
                    />
                    <path
                        id="Vector_22"
                    ...
                    <path
                        id="Vector_27"
                        d="M273 437.065C266.715 437.077 260.495 435.789 254.731 433.282L253.704 432.836L263.922 415.125H284.077L293.865 432.08L292.893 432.547C286.689 435.537 279.887 437.082 273 437.065V437.065ZM256.563 431.882C262.061 434.094 267.95 435.174 273.875 435.057C279.801 434.94 285.642 433.628 291.048 431.2L282.923 417.125H265.078L256.563 431.882Z"
                        fill="white"
                    />
                    <path
                        id="Vector_28"
    ...
    <MDBContainer fluid class="text-center text-md-left">
        <MDBRow>
            <MDBCol md="6" class="text-center">
                ...
                <p class="mt-2">
                    Sport Scientist - Sport Psychologist - Youth Football Coach
            ...
            <MDBCol md="3">
                ...
                <ul class="list-unstyled list-inline">
                    ...
                    <li class="list-unstyled list-inline-item">
                        <a href="mailto:nkosis@stjohnscollege.co.za"
                            ><MDBIcon fas icon="envelope-square" size="3x" /></a
                        >
                    </li>
                    <li class="list-unstyled list-inline-item">
                    ...
                    <li class="list-unstyled list-inline-item">
                        <a href="http://linkedin.com/in/simphiwe-nkosi-626999144"
                            ><MDBIcon fab icon="linkedin" size="3x" /></a
                        >
                    </li>
                </ul>
            </MDBCol>
            <MDBCol md="3">
                <MDBBtn class="mt-5" on:click={toTop} id="button"
                    >Scroll to top <MDBIcon fas icon="chevron-up" class="ml-3" /></MDBBtn
                >
            </MDBCol>
        </MDBRow>
    </MDBContainer>
