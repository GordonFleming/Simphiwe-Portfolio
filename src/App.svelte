<script>
    import {MDBBtn, MDBJumbotron, MDBContainer, MDBRow, MDBCol, MDBIcon, MDBCard, MDBCardBody, MDBFooter} from "mdbsvelte";
    ...
    <MDBContainer fluid>
        ...
        <MDBRow class="align-items-center">
            <MDBCol lg="6" md="12" sm="12">
                <img class="img-fluid d-block mx-auto" src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/circle-cropped-pp.png"  alt="Profile">
            </MDBCol>
            <MDBCol lg="6" md="12" sm="12" class="text-center">
...
<MDBContainer class="mt-5 mb-5 banner">
    <MDBRow class="d-flex align-items-center">
        <MDBCol  lg="6" md="12" sm="12">
            <img class="img-fluid" src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/analysis-self.webp" alt="analysis">
        </MDBCol>
        <MDBCol  lg="6" md="12" sm="12">
            <a href="/Documents/Simphiwe-Resume.pdf" target='_blank'><MDBBtn size="lg" class="d-block mx-auto" gradient="aqua">Resume</MDBBtn></a>
        </MDBCol>
    </MDBRow>
</MDBContainer>
...
<MDBContainer class="mt-5 mb-5 banner">
    <MDBRow class="d-flex align-items-center">
        <MDBCol  lg="6" md="12" sm="12">
            <a href="/Documents/Simphiwe-Reference-Letter.pdf" target='_blank'><MDBBtn size="lg" class="d-block mx-auto" gradient="aqua">Reference Letter</MDBBtn></a>
        </MDBCol>
        <MDBCol  lg="6" md="12" sm="12">
            <img class="img-fluid" src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/group-coach.webp" alt="coaches">
        </MDBCol>
    </MDBRow>
</MDBContainer>

<MDBContainer fluid class="mt-5 mb-5">
    <MDBRow class="d-flex align-items-center">
        <MDBCol lg="4" md="12" sm="12">
            <img class="img-fluid d-block mx-auto" src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/portrait.webp" alt="coaches">
        </MDBCol>
        <MDBCol lg="4" md="12" sm="12">
           <h2 class="text-center">I am a leader of good sense and sound values with a huge passion for developing people. I seek to
            contribute immensely to the quality of life of those I coach through sport and education. I have a driving
            passion for youth development and value hard work and humanity. I seek to continuously up-skill myself, striving to get better.</h2>
        </MDBCol>
        <MDBCol lg="4" md="12" sm="12">
            <img class="img-fluid d-block mx-auto" src="https://cdn.statically.io/gh/wolfbyne/Simphiwe-Portfolio/main/public/images/self-mic.webp" alt="coaches">
         </MDBCol>
    </MDBRow>
</MDBContainer>

<MDBContainer fluid class="mb-5 banner">
    <MDBRow class="d-flex align-items-center">
        <MDBCol lg="6" md="12" sm="12">
            <MDBCard>
                <MDBCardBody>
                    <form name="contact-me" method="POST">
                        ...
                        <br>
                        <label for="Textarea" class="grey-text font-weight-light">Your message...</label>
                        <textarea name="message" class="form-control" id="Textarea" rows="8"></textarea>
                        <br>
                        <MDBBtn class="d-block mx-auto" outline type="submit">
                            Send
        ...
        <MDBCol lg="6" md="12" sm="12">
            <svg class="img-fluid" width="857" height="511" viewBox="0 0 857 511" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="857" height="511" fill="#C7F9CC"/>
                ...
                <path id="Vector_6" d="M430.646 106.114C430.646 106.114 410.898 79.1272 391.711 107.143C372.487 135.213 354.613 158.258 354.613 158.258L306.868 173.825L279.245 176.276L286.855 200.834L367.168 189.183C367.168 189.183 456.582 136.069 430.646 106.114Z" fill="#2F2E41"/>
                ...
                <path id="Vector_14" d="M402.5 72.5652C418.516 72.5652 431.5 59.5815 431.5 43.5652C431.5 27.549 418.516 14.5652 402.5 14.5652C386.484 14.5652 373.5 27.549 373.5 43.5652C373.5 59.5815 386.484 72.5652 402.5 72.5652Z" fill="#9F616A"/>
                <path id="Vector_15" d="M428.5 40.5652C428.5 40.5652 444.5 60.5652 452.5 59.5652L417.5 86.5652C417.5 86.5652 413.5 69.5652 408.5 67.5652C403.5 65.5652 428.5 40.5652 428.5 40.5652Z" fill="#9F616A"/>
                <path id="Vector_16" d="M491 189.065C491 189.065 490.998 78.7189 472.487 69.2134C453.987 59.7134 441.749 54.2913 441.749 54.2913C441.477 57.912 440.448 61.4353 438.729 64.6335C437.01 67.8317 434.639 70.6337 431.769 72.8584C425.635 77.5941 419.524 81.5209 416.11 81.5335L416 81.0652L415.584 79.8764L405.5 95.5652C405.5 95.5652 396.5 97.5652 393.5 103.565C391.877 106.811 399.531 139.488 395 169.065C391.156 194.159 374.959 216.811 374.5 219.565C373.724 224.221 393.41 212.023 402.275 206.321C402.407 206.468 402.5 206.565 402.5 206.565C402.5 206.565 397.5 208.565 407.5 205.565C413.166 203.865 421.077 203.771 426.872 204.008C426.865 205.746 426.906 207.126 427 208.065C428 218.065 478 232.065 485 229.065C492 226.065 491 189.065 491 189.065Z" fill="#2F2E41"/>
                ...
                <path id="Vector_21" d="M483.444 82.9341C473.531 63.0082 443.369 73.8757 448.27 95.5848C448.344 95.9085 448.42 96.2353 448.5 96.5653C453.666 117.115 462.107 136.699 473.5 154.565L462.5 203.565L450.5 228.565L475.5 234.565L506.5 159.565C506.5 159.565 497.949 112.092 483.444 82.9341Z" fill="#2F2E41"/>
                <path id="Vector_22" opacity="0.2" d="M469 156.065L450 228.065L466 194.065L469 156.065Z" fill="black"/>
                <path id="Vector_23" d="M420.713 9.76134C420.713 9.76134 404.683 -7.11515 388.547 3.51302C372.412 14.1412 364.758 24.4654 366.34 31.654C367.922 38.8426 372.604 48.8416 372.604 48.8416C372.604 48.8416 369.694 33.9489 383.055 32.8468C396.415 31.7447 414.874 22.9031 414.874 22.9031L427.359 49.567C427.359 49.567 429.124 43.3881 434.018 45.1603C438.912 46.9326 435.119 11.7381 420.713 9.76134Z" fill="#2F2E41"/>
...
<MDBFooter color="default-color" class="font-small pt-4 mt-5">
    <MDBContainer fluid class="text-center text-md-left">
        <MDBRow>
            <MDBCol md="6" class="text-center">
                <h5 class="title">Simphiwe Alpheus Nkosi</h5>
                <p class="mt-2">Sport Scientist - Sport Psychologist - Youth Football Coach
                    <br> Houghton Estate, Johannesburg, South Africa
                </p>
                <div class="mt-1 mb-3">
            ...
            <MDBCol md="3">
                <h5 class="title mb-3">Socials</h5>
                <ul class="list-unstyled list-inline">
                    <li class="list-unstyled list-inline-item">
                        <a href="#!"><MDBIcon fab icon="facebook-square" size="3x"/></a>
                    </li>
                    <li class="list-unstyled list-inline-item">
                        <a href="mailto:nkosis@stjohnscollege.co.za"><MDBIcon fas icon="envelope-square" size="3x"/></a>
                    </li>
                    <li class="list-unstyled list-inline-item">
                        <a href="tel:+27768896093"><MDBIcon fas icon="phone-square" size="3x"/></a>
                    </li>
                    <li class="list-unstyled list-inline-item">
                        <a href="http://linkedin.com/in/simphiwe-nkosi-626999144"><MDBIcon fab icon="linkedin" size="3x"/></a>
                    </li>
                </ul>
            </MDBCol>
            <MDBCol md="3">
                <MDBBtn class="mt-5" on:click={toTop} id="button">Scroll to top <MDBIcon fas icon="chevron-up" class="ml-3"/></MDBBtn>
            </MDBCol>
        </MDBRow>
    </MDBContainer>
    <div class="footer-copyright text-center py-3">
        <MDBContainer fluid>
            &copy; {new Date().getFullYear()} Copyright: <a href="https://splyce.dev"> SPLYCE </a>
        </MDBContainer>
    </div>
</MDBFooter>